...
serviceModelEntityFromJson(ServiceModelEntity data, Map<String, dynamic> json) {
	if (json['ok'] != null) {
		data.ok = json['ok'];
	}
	if (json['who'] != null) {
	...
	if (json['result'] != null) {
		data.result = new ServiceModelResult().fromJson(json['result']);
	}
	if (json['nonce'] != null) {
...
Map<String, dynamic> serviceModelEntityToJson(ServiceModelEntity entity) {
...
serviceModelResultFromJson(ServiceModelResult data, Map<String, dynamic> json) {
	if (json['list'] != null) {
		data.xList = new List<ServiceModelResultList>();
		(json['list'] as List).forEach((v) {
			data.xList.add(new ServiceModelResultList().fromJson(v));
		});
	}
	return data;
}

Map<String, dynamic> serviceModelResultToJson(ServiceModelResult entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
serviceModelResultListFromJson(ServiceModelResultList data, Map<String, dynamic> json) {
	if (json['Serial'] != null) {
...
Map<String, dynamic> serviceModelResultListToJson(ServiceModelResultList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
