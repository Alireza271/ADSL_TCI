...
import 'package:ADSLTCI/generated/json/increase_credit_mopdel_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case TrafficModelEntity:
			...
			return trafficModelResultListFromJson(data as TrafficModelResultList, json) as T;			case TrafficDitailsModelEntity:
			...
			return trafficDitailsModelResultCostsFromJson(data as TrafficDitailsModelResultCosts, json) as T;			case ChangeServiceDitailModelEntity:
			...
			return changeServiceDitailModelResultCostsConfirminfoFromJson(data as ChangeServiceDitailModelResultCostsConfirminfo, json) as T;			case IncreaseCreditMopdelEntity:
			return increaseCreditMopdelEntityFromJson(data as IncreaseCreditMopdelEntity, json) as T;			case IncreaseCreditMopdelResult:
			return increaseCreditMopdelResultFromJson(data as IncreaseCreditMopdelResult, json) as T;			case IncreaseCreditMopdelResultBank:
			return increaseCreditMopdelResultBankFromJson(data as IncreaseCreditMopdelResultBank, json) as T;			case BankRedirectorModelEntity:
			return bankRedirectorModelEntityFromJson(data as BankRedirectorModelEntity, json) as T;			case BankRedirectorModelResult:
			return bankRedirectorModelResultFromJson(data as BankRedirectorModelResult, json) as T;			case ServiceDitailsModelEntity:
			...
			return serviceDitailsModelResultCostsFromJson(data as ServiceDitailsModelResultCosts, json) as T;			case ChangeServicesModelEntity:
			...
			return changeServicesModelResultListFromJson(data as ChangeServicesModelResultList, json) as T;			case ServiceModelEntity:
			...
			return serviceModelResultListFromJson(data as ServiceModelResultList, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case TrafficModelEntity:
			...
			return trafficModelResultListToJson(data as TrafficModelResultList);			case TrafficDitailsModelEntity:
			...
			return trafficDitailsModelResultCostsToJson(data as TrafficDitailsModelResultCosts);			case ChangeServiceDitailModelEntity:
			...
			return changeServiceDitailModelResultCostsConfirminfoToJson(data as ChangeServiceDitailModelResultCostsConfirminfo);			case IncreaseCreditMopdelEntity:
			return increaseCreditMopdelEntityToJson(data as IncreaseCreditMopdelEntity);			case IncreaseCreditMopdelResult:
			return increaseCreditMopdelResultToJson(data as IncreaseCreditMopdelResult);			case IncreaseCreditMopdelResultBank:
			return increaseCreditMopdelResultBankToJson(data as IncreaseCreditMopdelResultBank);			case BankRedirectorModelEntity:
			return bankRedirectorModelEntityToJson(data as BankRedirectorModelEntity);			case BankRedirectorModelResult:
			return bankRedirectorModelResultToJson(data as BankRedirectorModelResult);			case ServiceDitailsModelEntity:
			...
			return serviceDitailsModelResultCostsToJson(data as ServiceDitailsModelResultCosts);			case ChangeServicesModelEntity:
			...
			return changeServicesModelResultListToJson(data as ChangeServicesModelResultList);			case ServiceModelEntity:
			...
			return serviceModelResultListToJson(data as ServiceModelResultList);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'TrafficModelEntity':
			...
			return TrafficModelResultList().fromJson(json);			case 'TrafficDitailsModelEntity':
			...
			return TrafficDitailsModelResultCosts().fromJson(json);			case 'ChangeServiceDitailModelEntity':
			...
			return ChangeServiceDitailModelResultCostsConfirminfo().fromJson(json);			case 'IncreaseCreditMopdelEntity':
			return IncreaseCreditMopdelEntity().fromJson(json);			case 'IncreaseCreditMopdelResult':
			return IncreaseCreditMopdelResult().fromJson(json);			case 'IncreaseCreditMopdelResultBank':
			return IncreaseCreditMopdelResultBank().fromJson(json);			case 'BankRedirectorModelEntity':
			return BankRedirectorModelEntity().fromJson(json);			case 'BankRedirectorModelResult':
			return BankRedirectorModelResult().fromJson(json);			case 'ServiceDitailsModelEntity':
			...
			return ServiceDitailsModelResultCosts().fromJson(json);			case 'ChangeServicesModelEntity':
			...
			return ChangeServicesModelResultList().fromJson(json);			case 'ServiceModelEntity':
			...
			return ServiceModelResultList().fromJson(json);    }
    return null;
  }
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'TrafficModelEntity':
			...
			return List<TrafficModelResultList>();			case 'TrafficDitailsModelEntity':
			...
			return List<TrafficDitailsModelResultCosts>();			case 'ChangeServiceDitailModelEntity':
			...
			return List<ChangeServiceDitailModelResultCostsConfirminfo>();			case 'IncreaseCreditMopdelEntity':
			return List<IncreaseCreditMopdelEntity>();			case 'IncreaseCreditMopdelResult':
			return List<IncreaseCreditMopdelResult>();			case 'IncreaseCreditMopdelResultBank':
			return List<IncreaseCreditMopdelResultBank>();			case 'BankRedirectorModelEntity':
			return List<BankRedirectorModelEntity>();			case 'BankRedirectorModelResult':
			return List<BankRedirectorModelResult>();			case 'ServiceDitailsModelEntity':
			...
			return List<ServiceDitailsModelResultCosts>();			case 'ChangeServicesModelEntity':
